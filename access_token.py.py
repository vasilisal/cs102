...
def get_access_token(client_id, scope):
    ...
    url = """    https://oauth.vk.com/authorize?client_id={client_id}&    redirect_uri=https://oauth.vk.com/blank.hmtl&    scope={scope}&    &response_type=token&    display=page    """.replace(" ", "").format(client_id=client_id, scope=scope)
